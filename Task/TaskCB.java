...
*       @OSPProject Tasks
    */
    ...
    {
      DefaultStr = "XXL@";
      MyOut.print(DefaultStr, "Task default priority is initiated to 2");
      DefaultPriority = 2;
    }
...
*        @OSPProject Tasks
    */
    ...
    {
      MyOut.print(DefaultStr, " creating task...");
        // Creates Task object
        ...
        */
        String pathname = GlobalVariables.SwapDeviceMountPoint + Integer.toString(newTask.getID());
        FileSys.create(pathname, (int)Math.pow(2, MMU.getVirtualAddressBits()));
        ...
        */
        if (swapFile == null) {
      MyOut.warning(DefaultStr, " task creation fail.");
            ThreadCB.dispatch();
            return null;
        } else{
      ...
      MyOut.print(DefaultStr, " task creation successful.");
        return newTask;
    }
 ...
 *      SUCCESS otherwise.
  ...
  *  */
    public int do_addThread(ThreadCB thread)
    {
      ...
      MyOut.print(this, DefaultStr + " fail to add thread " + thread + " to task cause limited thread amount");
...
* 
    ...
    */ 
    public int do_addPort(PortCB newPort)
    {
      ...
      MyOut.print(this, DefaultStr + " cannot add new port cause limited port amount");
            return GlobalVariables.FAILURE;
        }
