    ...
    */
    private void do_statistics(long terminationTime){
        ...
        for (ThreadStat ts: threadStatsList) {
            // MyOut.print(ts.thread, ts.toString());//Calculate minimum running time
            ...
            totalCPUT += ts.thread.getTimeOnCPU();
            totalT += ts.runningTime;  
            totalNumberKilled ++;
            printStat(totalT, totalCPUT, totalNumberKilled, ts.terminationTime);
        }
