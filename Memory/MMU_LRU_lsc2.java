...
public class MMU extends IflMMU
{
    ...
    */
    ...
    /**
    *   This method keep LRU count of frame in order. The target 
    *   is set to 0, frames that has lower count will increment.
    */
    private static void do_LRUAlignment(FrameTableEntry frame){
      MyOut.print(thread, "LRU is align");
      ...
      for (int i = 0; i < frameTableSize; i++) {
        ...
        if (!frame.isOccupied()) {
          if (frame.getPage() != null){
            ...
            if (page.getTask().getStatus() == ThreadKill){
